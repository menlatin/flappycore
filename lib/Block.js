...
Block.getBlockValue = function getBlockValue(height) {
  var subsidy;
    if (height > 0 && height < 109999) { subsidy = (1000000 * 100000000);
    } else if (height > 110000 && height < 139999) { subsidy = (100000 * 100000000);
    } else if (height > 140000 && height < 140499) { subsidy = (1000000 * 100000000);
    } else if (height > 140500 && height < 199999) { subsidy = (100000 * 100000000);
    } else if (height > 200000 && height < 299999) { subsidy = (50000 * 100000000);
    } else if (height > 300000 && height < 399999) { subsidy = (25000 * 100000000);
    } else if (height > 400000 && height < 499999) { subsidy = (12500 * 100000000);
    } else if (height > 500000 && height < 599999) { subsidy = (6250 * 100000000);
    } else if (height > 600000 && height < 699999) { subsidy = (50 * 100000000);
    } else if (height > 700000 ) { subsidy = (50 * 100000000); //TODO calc 1% for 700k+
    };
  return subsidy;
};
